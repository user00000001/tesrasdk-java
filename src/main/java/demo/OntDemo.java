...
public class OntDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            com.github.TesraSupernet.account.Account payerAcct = new com.github.TesraSupernet.account.Account(Helper.hexToBytes(privatekey0),ontSdk.defaultSignScheme);
            ...
            com.github.TesraSupernet.account.Account acct6 = new com.github.TesraSupernet.account.Account(Helper.hexToBytes(privatekey6), ontSdk.defaultSignScheme);
            ...
            if(true){//sendTransferFromMultiSignAddr
                ...
                com.github.TesraSupernet.account.Account acct04 = new com.github.TesraSupernet.account.Account(Helper.hexToBytes("0638dff2f03964883471e1dac3df9e7738f21fd2452aef4846c11a53be6feb0e"),ontSdk.defaultSignScheme);
                com.github.TesraSupernet.account.Account acct05 = new com.github.TesraSupernet.account.Account(Helper.hexToBytes("46027c9786e24ecc1b4d7b406dfe90ec30b2c2fa6ad2f7963df251200e7f003d"),ontSdk.defaultSignScheme);
                com.github.TesraSupernet.account.Account acct06 = new com.github.TesraSupernet.account.Account(Helper.hexToBytes("523c5fcf74823831756f0bcb3634234f10b3beb1c05595058534577752ad2d9f"),ontSdk.defaultSignScheme);
                com.github.TesraSupernet.account.Account acct07 = new com.github.TesraSupernet.account.Account(Helper.hexToBytes("1094e90dd7c4fdfd849c14798d725ac351ae0d924b29a279a9ffa77d5737bd96"),ontSdk.defaultSignScheme);
...
//            System.out.println(Helper.toHexString(acct33.serializePublicKey()));
                ...
                ontSdk.nativevm().ont().sendTransferFromMultiSignAddr(M,pks,new com.github.TesraSupernet.account.Account[]{acct00,acct01,acct02,acct03,acct04},acct1.getAddressU160().toBase58(),5,acct0,ontSdk.DEFAULT_GAS_LIMIT,0);
                System.exit(0);
            }
            if(true){ //M < n
                com.github.TesraSupernet.account.Account acct00 = new com.github.TesraSupernet.account.Account(Helper.hexToBytes("dcb22fdeb1cd57c4ad82c8dc21dd6792d4b1e90b5aa06d6698c03eacddabeb1f"),SignatureScheme.SM3WITHSM2);
...
//                System.exit(0);
                String hash = ontSdk.nativevm().ont().sendTransfer(acct0,"AUe2KKPnNMnM7hLHj6dEPJ4PA2m4pyJt2d",200,acct0,ontSdk.DEFAULT_GAS_LIMIT,0);
                System.out.println(hash);
                //Thread.sleep(6000);
