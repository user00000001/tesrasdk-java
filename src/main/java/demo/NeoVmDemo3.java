...
//            Account account7s = getAccount("ZG/SfHRArUkopwhQS1MW+a0fvQvyN1NnwonU0oZH8y1bGqo5T+dQz3rz1qsXqFI2","1","AQNpGWz4oHHFBejtBbakeR43DHfen7cm8L","6qiU9bgK/+1T2V8l14mszg==");
            ...
            if(false){
                ...
                Object result = tstSdk.getConnect().syncSendRawTransaction(txHex);
            ...
            if(false){
                ...
                if (preExec){
                    Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse(youleAddress),null,null,20000,0,func, preExec);
                    System.out.println(obj);
                }else {
                    Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse(quanjiaAddress),adminAcct,adminAcct,20000,0,func, preExec);
                    System.out.println(obj);
                    Thread.sleep(6000);
                    System.out.println(tstSdk.getConnect().getSmartCodeEvent((String) obj));
                }
                return;
            }
            ...
            if (false){
                ...
                Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse(quanjiaAddress),null,null,20000,0,func, preExec);
                System.out.println(obj);
                return;
            }
            //
            ...
            if (false){
                ...
                AbiFunction func = abiinfo.getFunction(name);
                boolean preExec = true;
                Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse(swapAddress2),null,null,20000,0,func, preExec);
                System.out.println(obj);
                return;
            }
            Account adminAcct = new Account(Helper.hexToBytes("75de8489fcb2dcaf2ef3cd607feffde18789de7da129b5e97c81e001793cb7cf"),SignatureScheme.SHA256WITHECDSA);
            ...
            if (false){
                ...
                boolean preExec = false;
                Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse(swapAddress2),adminAcct,adminAcct,20000,0,func, preExec);
                System.out.println(obj);
                Thread.sleep(6000);
                System.out.println(tstSdk.getConnect().getSmartCodeEvent((String)obj));
                return;
            ...
            if (true){
                ...
                boolean preExec = false;
                Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse(swapAddress2),adminAcct,adminAcct,20474,0,func, preExec);
                System.out.println(obj);
                Thread.sleep(6000);
                System.out.println(tstSdk.getConnect().getSmartCodeEvent((String)obj));
                return;
            ...
            if(true){
                ...
                boolean preExec = false;
                Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse("df57f2c82646b96ce2ae68dba27460958b46abf7"),youleAcct,adminAcct,20000,500,func, preExec);
                System.out.println(obj);
                Thread.sleep(6000);
                System.out.println(tstSdk.getConnect().getSmartCodeEvent((String) obj));
                return;
            ...
            if(false){
                com.github.TesraSupernet.sdk.wallet.Account adminAcc = tstSdk.getWalletMgr().importAccount("bBkseVtWdArWNc2OfVnNONt+FV+6RRgvle2ffxYNrOU3bzGzq3dG07PXkzlunfi2","xinhao","AQf4Mzu1YJrhz9f3aRkkwSm9n3qhXGSh4p",Base64.getDecoder().decode("1NF1DK9zgDyB2cAcSRfB6w=="));
                //有乐管理员Account
                Account youleadminAcct = tstSdk.getWalletMgr().getAccount("AQf4Mzu1YJrhz9f3aRkkwSm9n3qhXGSh4p","xinhao");
                com.github.TesraSupernet.sdk.wallet.Account quanjiaadminAcc = tstSdk.getWalletMgr().importAccount("zJ2+ScaXH04G7zHh9QatqJTx4aZS1ehJ4TQlPAJ6n4qZZfzV6iWfC0novEzNwzil","xinhao","ANTPeXCffDZCaCXxY9u2UdssB2EYpP4BMh",Base64.getDecoder().decode("nAb1JNde0mC2PDYs9knxcQ=="));
                //全家管理员Account
                Account quanjiaadminAcct = tstSdk.getWalletMgr().getAccount("AQf4Mzu1YJrhz9f3aRkkwSm9n3qhXGSh4p","xinhao");
                ...
                boolean preExec = false;
                if (preExec){
                    Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse("fb2ce5bd31bfb50662d95aaef1badcb8f8b71ce1"),null,null,20000,0,func, preExec);
                    System.out.println(obj);
                }else {
                    Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse("44f1f4ee6940b4f162d857411842f2d533892084"),quanjiaadminAcct,quanjiaadminAcct,20000,0,func, preExec);
            ...
            if(false){
                ...
                boolean preExec = true;
                if (preExec){
                    Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse("d755c02caf5741b1c3352a06a41271716a1fca78"),null,null,20000,0,func, preExec);
                    System.out.println(obj);
                }else {
                    Object obj =  tstSdk.neovm().sendTransaction(Helper.reverse("fb2ce5bd31bfb50662d95aaef1badcb8f8b71ce1"),quanjiaadminAcct,quanjiaadminAcct,20000,0,func, preExec);
            ...
            if(false){
                ...
                tstSdk.neovm().sendTransaction(Helper.reverse("44f1f4ee6940b4f162d857411842f2d533892084"),acct,acct,20000,500,func,false);
//
//                Transaction tx = tstSdk.vm().makeInvokeCodeTransaction(Helper.reverse("44f1f4ee6940b4f162d857411842f2d533892084"),null,params,account3.getAddressU160().toBase58(),20000,0);
//                tstSdk.signTx(tx,new Account[][]{{account999}});
//                tstSdk.addSign(tx,account3);
...
//                System.out.println(tstSdk.getConnect().getSmartCodeEvent(tx.hash().toHexString()));
            ...
            if(transferMulti){
                ...
                Transaction tx = tstSdk.vm().makeInvokeCodeTransaction(Helper.reverse("ad0bd8c715fcec8d7b3bed0fd1c88fcc8ef43927"),null,params,account.getAddressU160().toBase58(),20000,0);
                tstSdk.signTx(tx,new Account[][]{{account}});
                tstSdk.addSign(tx,adminAcct);
                tstSdk.getConnect().sendRawTransaction(tx);
