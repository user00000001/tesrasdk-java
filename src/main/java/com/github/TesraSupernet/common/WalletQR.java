...
import com.github.TesraSupernet.sdk.wallet.*;
...
public class WalletQR {
    public static Map exportIdentityQRCode(Wallet walletFile, Identity identity) throws Exception {
        ...
        String address = identity.tstid.substring(8);
        Map map = new HashMap();
        map.put("type", "I");
    ...
    public static String getPriKeyFromQrCode(String qrcode,String password) throws SDKException {
        ...
        try {
            return com.github.TesraSupernet.account.Account.getGcmDecodedPrivateKey(key,password,address, Base64.getDecoder().decode(salt),n, SignatureScheme.SHA256WITHECDSA);
        } catch (Exception e) {
