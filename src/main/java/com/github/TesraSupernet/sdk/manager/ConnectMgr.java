...
import com.github.TesraSupernet.network.connect.IConnector;
import com.github.TesraSupernet.network.rest.RestClient;
import com.github.TesraSupernet.network.rest.Result;
import com.github.TesraSupernet.network.websocket.WebsocketClient;
...
public class ConnectMgr {
    ...
    public String getGrantTsg(String address) throws ConnectorException, IOException {
        return connector.getGrantTsg(address);
    }
