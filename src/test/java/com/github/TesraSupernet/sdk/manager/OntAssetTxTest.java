...
public class OntAssetTxTest {
    ...
    public void sendTransfer() throws Exception {
        com.github.TesraSupernet.account.Account sendAcct = ontSdk.getWalletMgr().getAccount(info1.address,password,info1.getSalt());
    ...
    public void sendApprove() throws Exception {
        com.github.TesraSupernet.account.Account sendAcct1 = ontSdk.getWalletMgr().getAccount(info1.address,password,info1.getSalt());
        com.github.TesraSupernet.account.Account sendAcct2 = ontSdk.getWalletMgr().getAccount(info2.address,password,info2.getSalt());
        com.github.TesraSupernet.account.Account payerAcct = ontSdk.getWalletMgr().getAccount(payer.address,password,payer.getSalt());
